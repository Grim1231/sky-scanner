"""Parse Ethiopian Airlines Sputnik fare search into NormalizedFlight objects."""
...
def parse_fares(
    ...
    *,
    ...
    """Convert Ethiopian Airlines Sputnik fare entries into NormalizedFlight list.
    ...
    Each entry in the raw list looks like::

        {
            ...
            "journeyType": "ONE_WAY",
            "outboundFlight": {
                "departureAirportIataCode": "ADD",
                "arrivalAirportIataCode": "NBO",
                "fareClass": "ECONOMY",
                "fareClassInput": "seat",
                ...
            },
    ...
    for entry in raw:
        ...
        currency: str = price_spec.get("currencyCode", "USD")
        ...
        try:
            ...
            logger.warning("Invalid date in Ethiopian Airlines fare: %s", date_str)
            continue
        ...
        flights.append(
            NormalizedFlight(
                flight_number=f"{_ET_CODE}-{dep_airport}{arr_airport}",
                airline_code=_ET_CODE,
                airline_name=_ET_NAME,
                operator=_ET_CODE,
                origin=dep_airport,
    ...
    logger.info(
        "Parsed %d daily lowest fares for %s->%s from Ethiopian Airlines",
        len(flights),
        origin_filter or "*",
